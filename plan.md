...
The diagram's two halves are not two separately-invoked tools. **One CLI spans the whole pipeline**, stages 0 through 8C, reading the project structure descriptor for all configuration. The determinism boundary is enforced in *how* it drives each half, not in *who* invokes it:
